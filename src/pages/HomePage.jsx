...
import { FaTruck, FaBox, FaRoad, FaUserTie, FaCheckCircle } from 'react-icons/fa';
...
const HomePage = () => {
  ...
  const iconVariants = {
    initial: { scale: 1, rotate: 0, color: '#1E40AF' }, // sky-600
    hover: { 
      scale: 1.2, 
      rotate: 360, // 360-degree spin
      color: '#EAB308', // yellow-600
      transition: { 
        rotate: { duration: 0.6, ease: 'linear' }, // Single spin on hover
    ...
    <div className="bg-white overflow-hidden">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
          ...
          >
            Welcome to Golden Roadways and Logistics
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-yellow-300 text-sky-900 px-8 py-4 rounded-full text-xl font-bold hover:bg-yellow-400 transition duration-300 shadow-lg"
          >
            Enquire Now!
          </motion.a>
        </div>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            At Golden Roadways and Logistics, we understand that every business has
            unique logistics needs. That’s why we offer personalized quotes tailored
            to your specific requirements. Whether you need road transport, warehousing,
            or a comprehensive logistics solution, we’re here to provide you with the
            most cost-effective and efficient service.
          </motion.p>
          <form
          ...
          >
            ...
            <motion.div variants={childVariants} className="mb-6">
              ...
              >
                ...
                <option value="logistics-solution">Comprehensive Logistics Solution</option>
              </select>
            </motion.div>
            <motion.button
              variants={childVariants}
      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            Golden Roadways and Logistics is a premier domestic logistics company in
            India, committed to delivering reliable and efficient transportation
            solutions to businesses nationwide. With a deep understanding of the
            complexities of logistics, we have built a reputation for excellence in
            service, driven by our mission to simplify the logistics process for our
            clients.
          </motion.p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              >
                Established with a vision to provide top-notch logistics services,
                Golden Roadways and Logistics has grown into a trusted partner for
                businesses across various sectors. From small enterprises to large
                corporations, our clients rely on us to ensure that their goods are
                transported safely, swiftly, and cost-effectively. Our experienced team
                of logistics professionals is dedicated to meeting and exceeding customer
                expectations by delivering tailored solutions that align with their
                specific needs.
              </motion.p>
            </motion.div>
            <motion.div 
            ...
            >
              ...
              >
                ...
                services that streamline operations, reduce costs, and enhance supply
                chain efficiency. We strive to build lasting relationships with our
                clients by offering dependable, innovative, and customer-centric solutions
                that drive success.
              </motion.p>
            </motion.div>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: FaTruck, title: 'Reliability', desc: 'We deliver on our promises, ensuring your goods arrive safely and on time.' },
              { icon: FaUserTie, title: 'Expertise', desc: 'Our team has the knowledge and skills to handle complex logistics challenges.' },
              { icon: FaBox, title: 'Customer-Centric', desc: 'We work closely with clients to deliver solutions that exceed expectations.' },
              { icon: FaRoad, title: 'Innovation', desc: 'We leverage technology for efficient, transparent logistics solutions.' },
            ].map((item, index) => (
              <motion.div
                key={index}
                variants={cardVariants}
              ...
              >
                <motion.div
                  ...
                  style={{ transformOrigin: 'center center' }} // Ensure rotation happens around the icon's center
                >
                  <item.icon />
                </motion.div>
                <motion.h3 
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: FaTruck, title: 'Logistics Solutions', desc: 'Comprehensive logistics services to transport goods across the country efficiently.' },
              { icon: FaBox, title: 'Courier Service', desc: 'Fast and reliable courier services for businesses and individuals.' },
              { icon: FaRoad, title: 'Full Truckload Services', desc: 'Door-to-door full truckload services tailored to your needs.' },
            ].map((service, index) => (
              <motion.div
                key={index}
                variants={cardVariants}
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            “Golden Roadways and Logistics has been a game-changer for our supply chain.
            Their on-time delivery and excellent customer service have made them our
            go-to logistics partner. We’ve seen a significant improvement in our
            operations since we started working with them.”
          </motion.blockquote>
          <motion.p
            variants={childVariants}
